...
{
    [BepInPlugin("com.gorillatag.notifications", "Notifi Lib", "1.0.0")]
    public class NotifiLib : BaseUnityPlugin
    {
        private void Awake()
        {
            Logger.LogInfo("Loaded Notifi Lib 🔗 Nyphs Menu Template.");
        }
        ...
        private void Init()
        {
            ...
            HUDObj2.name = "Notif Hud";
            HUDObj.name = "Notification Hud";
            ...
            Testtext.horizontalOverflow = HorizontalWrapMode.Overflow;
            ...
            if (!disableNotifications)
            {
                try
                {
                    if (IsEnabled && PreviousNotifi != NotificationText)
                    {
                        ...
                        Classes.Logger.Info("Notification sent: " + NotificationText);
                    }
                }
                catch
                {
